  ...
  \******************************/
      ...
      /***/ function(module, exports) {
        ...
        $(document).ready(function() {
          ...
          var cd_tipo_imovel_ativo = $("#cd_tipo_imovel :selected")
            .parent()
            .attr("value");
          $("#cd_tipo_imovel").change(function() {
            var new_tipo_imovel = $("#cd_tipo_imovel :selected")
              .parent()
              .attr("value");
          ...
          function buscar_areas_tipo(tipo) {
            ...
            $("#AreasPrivativasChecks, #AreasComunsChecks").html(
              '<i class="fa fa-spinner fa-pulse fa-2x fa-fw"></i> Carregando áreas.'
            );
        ...
        $(document).ready(function() {
          ...
          if (window.lrv_data) {
            ...
            precoDe.value = Number(
              $("#slider-range").slider("values", 0)
            ).toLocaleString("pt-BR", formato);
            precoAte.value = Number(
  ...
  \************************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        module.exports = __webpack_require__(
          /*! C:\xampp\htdocs\HUGO\p_flx\resources\js\imob.js */ "./resources/js/imob.js"
        );
